export function PolicyContent() {
  return (
    <>
      ...
      <h3>Personal Data</h3>
      <p>
        Personally identifiable information, such as your name, email address, and demographic information, like your age, gender, and interests, that you voluntarily give to us when you register with the Service.
      </p>
      <h3>Usage Data</h3>
      <p>
      ...
      <p>
        You have the right to access, correct, or delete your personal data. You may review or change the information in your account or terminate your account at any time by logging into your account settings.
      </p>
      ...
      <p>
        ...
        Calobite Inc.
        <br />
        Email: <a href="mailto:privacy@calobite.com">privacy@calobite.com</a>
      </p>
    </>
  );
}
